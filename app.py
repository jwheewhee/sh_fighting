...
DAY_DATA = {
    ...
    4: {
        ...
        "message": (
            ...
            "아무것도 안 해도 돼. 그냥 숨만 쉬어.\n"
            "언니가 거기 있다는 것만으로도 나 행복해 ☀️"
        ),
    },
    5: {
        "emoji": "🤍",
        ...
        "message": (
            "중환자실.. 낯설고 무섭지?\n"
            "모르는 곳에서 혼자 있는 느낌 들 것 같아서 내 마음도 같이 아파.\n"
            "근데 언니 나 항상 응원하고 있어!\n"
    ...
    8: {
        ...
        "message": (
            ...
            "나는 이때도 언니가 진짜 정말 좋았어.\n"
            "어색했어도 같이 있는 게 그냥 좋았거든 🎉\n"
            "다 나으면 연말 파티 하자 ~ 우리 꼭!!!"
        ),
    },
    9: {
        ...
        "message": (
            ...
            "지금 언니한테 비가 많이 오고 있는 거 알아.\n"
            "근데 그 다음에 뜰 무지개 진짜 크고 선명할 거야 🌈\n"
            "나 그 무지개 언니랑 같이 보고 싶어."
        ),
    },
    10: {
        "emoji": "🌙",
    ...
    11: {
        ...
        "video": None,
        "message": (
            "해바라기 알지? 해를 향해 항상 고개 드는 꽃.\n"
            "언니가 딱 그래.\n"
            "힘들어도 밝은 쪽으로 고개 드는 사람.\n"
            "나는 언니 보면서 진짜 많이 배워 🌻"
        ),
    },
    12: {
        ...
        "message": (
            "언니 웃는 거 진짜 예쁜 거 알아?\n"
            "나 그 웃음 보면 괜히 나도 기분 좋아지거든.\n"
            "오늘 하루 딱 한 번만 웃어줄 수 있어?\n"
            "언니 웃는 거 보고 싶어서 그래 😊💛"
        ),
    },
    13: {
    ...
    20: {
        ...
        "message": (
            ...
            "다 나으면 진짜로 다 먹으러 갈 거야.\n"
            "맛있는 거 잔뜩 먹자 ~~ 🍽️\n"
            "제일 먹고 싶은 거 1순위 생각해두기 ~"
        ),
    },
    21: {
        "emoji": "🌊",
...
# ══════════════════════════════════════════════
with tab3:
    st.markdown("#### 우리 인생네컷 타임랩스 🎬")
    st.caption("소리는 없어도 더 소중한 우리 영상들 💛")
